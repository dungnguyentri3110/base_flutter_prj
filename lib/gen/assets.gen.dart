...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/ic_eyes.svg
  String get icEyes => 'assets/icons/ic_eyes.svg';

  /// File path: assets/icons/ic_lock.svg
  String get icLock => 'assets/icons/ic_lock.svg';

  /// File path: assets/icons/ic_toast_error.svg
  String get icToastError => 'assets/icons/ic_toast_error.svg';

  /// File path: assets/icons/ic_toast_success.svg
  String get icToastSuccess => 'assets/icons/ic_toast_success.svg';
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [intro1, intro2, intro3, logo];
}
